...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.SYNC_S3_RENAME_GZIP_EXT: str = getattr(
            settings,
        ...
        if media_root is None:
            raise CommandError(
                'MEDIA_ROOT should be set in your settings file'
            )
    ...
    def _handle_upload(self, root: str, dirs: list[str], files: list[str], **params):
